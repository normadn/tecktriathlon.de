...
import EventScheduleCompressedTable from "../../../components/EventScheduleCompressedTable";
...
describe("EventScheduleCompressedTable", () => {
  it("renders correctly", () => {
    expect(
      shallow(<EventScheduleCompressedTable data={addDurations(schedule)} />)
    ).toMatchSnapshot();
  });
});
